...
<!-- home-columns -->
				<div class="home-columns clearfix">
					...
					<div class="one-half">
								...
								<div class="post-item clearfix">
									...
									<div class="square-thumbnail">
										...
										if (has_post_thumbnail()) {
											...
											<img src="<?php echo get_template_directory_uri(); ?>/images/testPic.jpg">
						...
						<span class="horiz-center"><a href="<?php echo get_category_link(6); ?>" class="btn-a">View all Opinion Posts</a></span>
					...
					<div class="one-half last">
						...
						<span class="horiz-center"><a href="<?php echo get_category_link(5); ?>" class="btn-a">View all News Posts</a></span>
